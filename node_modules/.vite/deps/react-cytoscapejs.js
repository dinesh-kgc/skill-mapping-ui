...
function _arrayLikeToArray(r2, a2) {
  ...
  for (var e2 = 0, n = Array(a2); e2 < a2; e2++)
    n[e2] = r2[e2];
  return n;
}
...
function intersection(set1, set2) {
  if (set1.intersection)
    ...
    return new Set(_toConsumableArray(set1).filter(function(x3) {
      return set2.has(x3);
    }));
}
...
var ElementDrawingWebGL = function() {
  ...
  return _createClass(ElementDrawingWebGL2, [{
    ...
    value: function createShaderProgram(renderTarget) {
      ...
      program.uTextures = [];
      for (var i2 = 0; i2 < this.atlasManager.getMaxAtlasesPerBatch(); i2++) {
    ...
    value: function getCurveSegmentPoints(controlPoints3, segments) {
      ...
      for (var i2 = 0; i2 <= segments; i2++) {
        if (i2 == 0) {
          ...
          var t2 = i2 / segments;
          this.setCurvePoint(controlPoints3, t2, curvePoints, i2 * 2);
        }
      }
      return curvePoints;
    }
    ...
    key: "setCurvePoint",
    value: function setCurvePoint(points, t2, curvePoints, cpi) {
      if (points.length <= 2) {
        ...
        return this.setCurvePoint(newpoints, t2, curvePoints, cpi);
      }
    }
  }, {
    key: "endBatch",
...
var OverlayUnderlayRenderer = function() {
  ...
  return _createClass(OverlayUnderlayRenderer2, [{
    ...
    value: function getStyleKey(type, node) {
      ...
      var w2 = node.width();
      var h2 = node.height();
      var c2 = fillStyle(color, opacity);
      return hashString("".concat(shape, "-").concat(w2, "-").concat(h2, "-").concat(c2));
    }
  }, {
    key: "isVisible",
    ...
    value: function draw(type, context, node, bb) {
      ...
      if (shape === "round-rectangle" || shape === "roundrectangle") {
        r2.drawRoundRectanglePath(context, x3, y3, w2, h2, "auto");
      } else if (shape === "ellipse") {
        r2.drawEllipsePath(context, x3, y3, w2, h2);
      }
      context.fill();
      context.restore();
    }
...
CRp$4.initWebgl = function(opts, fns) {
  ...
  r2.drawing.addAtlasCollection("node", atlasCollectionDefaults({
    texRows: opts.webglTexRowsNodes
  }));
  r2.drawing.addAtlasCollection("label", atlasCollectionDefaults({
    texRows: opts.webglTexRows
  }));
  r2.drawing.addAtlasRenderType("node-body", renderDefaults({
    collection: "node",
    getKey: fns.getStyleKey,
    getBoundingBox: fns.getElementBox,
    drawElement: fns.drawElement
  }));
  r2.drawing.addAtlasRenderType("label", renderDefaults({
  ...
  r2.drawing.addAtlasRenderType("node-overlay", renderDefaults({
    collection: "node",
    getBoundingBox: fns.getElementBox,
  ...
  r2.drawing.addAtlasRenderType("node-underlay", renderDefaults({
    collection: "node",
    getBoundingBox: fns.getElementBox,
    getKey: function getKey3(ele) {
  ...
  r2.drawing.addAtlasRenderType("edge-source-label", renderDefaults({
    collection: "label",
  ...
  r2.drawing.addAtlasRenderType("edge-target-label", renderDefaults({
    collection: "label",
